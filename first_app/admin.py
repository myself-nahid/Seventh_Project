...
from first_app.models import StudentModel, StudentInfoModel, TeacherInfoModel, EmployeeModel, ManagerModel, Friend, Persion, Passport, Post, Student, Teacher
...
#     list_display = ['id', 'user', 'pass_no', 'page', 'validity']
